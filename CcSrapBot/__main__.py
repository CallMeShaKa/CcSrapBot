...
from CcSrapBot import (API_KEY, CERT_PATH, IP_ADDRESS, LOGGER, OWNER_ID, PORT,
                       URL, WEBHOOK, dispatcher, updater)
from CcSrapBot.modules import ALL_MODULES

PM_START_TEXT = """
Hey {}, I'm {}!
I'm a bot used to sending messages from one chat to another.
...
for module in ALL_MODULES:
    importlib.import_module("CcSrapBot.modules." + module)
